      ...
      <div className="flex-1 flex items-center justify-center py-20 px-4 relative overflow-hidden">
        ...
        <div className="w-full max-w-4xl relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <motion.a 
              href="https://instagram.com/biru_menara" 
              target="_blank" 
              rel="noreferrer"
            ...
            >
              ...
              <div>
                ...
                <p className="text-pink-400 font-medium text-lg">@biru_menara</p>
          ...
          <motion.div 
            ...
            className="mt-6 glass p-8 rounded-3xl border border-white/10 flex flex-col md:flex-row items-center justify-center gap-6 text-center md:text-left"
          >
            ...
            <div>
              <h3 className="text-xl font-bold text-white mb-2">สถานที่ตั้ง / กองอำนวยการสีฟ้า</h3>
              <p className="text-lg text-gray-300">โรงเรียนอัตตัรกียะห์อิสลามียะห์</p>
              <p className="text-gray-400">จ.นราธิวาส 96000</p>
            </div>
          </motion.div>
